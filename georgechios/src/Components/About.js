      ...
      <div>
        <div>
          ...
          <article className="pictureLeft">
            <img className="articlePicture invert" src="https://via.placeholder.com/300x300" alt="Profile Picture of George" />
